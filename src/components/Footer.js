...
const Footer = () => {
  return (
    <section id="contact">
      <footer
        className="py-10 bg-gradient-to-r from-teal-200 via-teal-300 to-blue-400 text-black text-center px-6"
      >
        <div className="max-w-7xl mx-auto">
          <h2 className="text-xl font-semibold">Stay Connected</h2>
          ...
          <div className="flex justify-center space-x-6 mt-4 text-xl">
            <a
              href="https://www.linkedin.com/in/krati-joshi-9b000a20b/"
            ...
            <a
              href="https://github.com/KRATI-cmd"
              className="flex items-center space-x-2 hover:text-gray-600"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <p className="text-xs text-gray-600 mt-8">
            © {new Date().getFullYear()} All Rights Reserved.{" "}
            <span className="font-semibold text-pink-600">Made with ❤️ by Krati Joshi</span>.
          </p>
        </div>
      </footer>
    </section>
